...
win = font1.render('Victory!', True, (255, 255, 255)) #(kalimat, penentu tampil di layar, nomor warna)
lose = font1.render('Deafeat!', True, (180, 0, 0))
...
mixer.init()
#backsound
mixer.music.load('space.ogg.opus')
mixer.music.play()
...
img_bullet = "Peluru.png"  # bullet
img_hero = "Gun.png"  # hero
img_enemy = "Zombie.png"  # enemy

#step 5: set variable acuan
score = 0  # ships destroyed
goal = 15  # how many ships need to be shot down to win
lost = 0  # ships missed
